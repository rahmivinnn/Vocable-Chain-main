...
namespace Samples.Purchasing.Core.BuyingConsumables
{
    public class BuyingConsumables : MonoBehaviour, IDetailedStoreListener
    {
        ...
        void InitializePurchasing()
        {
            ...
            builder.AddProduct(goldProductId,UnityEngine.Purchasing.ProductType.Consumable);
            builder.AddProduct(diamondProductId, UnityEngine.Purchasing.ProductType.Consumable);
